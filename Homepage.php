			...
			<div class="site-header">
				<div class="container">
					<a href="index.html" class="branding">
						<img src="images/logo.png" alt="" class="logo" width="200px" height="50px" >
						<!-- <div class="logo-type">
				...
				<div class="container">
					<div class="forecast-container">
						<div class="today forecast">
							<div class="forecast-header" class="center">
								<div class="title">GEOLOCATION</div>
						
							</div> <!-- .forecast-header -->
							<div class="forecast-content" class="right">

								<center>
								<div class="degree">
									<div class="forecast-icon">
										<img src="https://img.icons8.com/office/35/000000/worldwide-location.png">
										<span class="location" id = "locationname" ></span>
									</div>	
								</div>
									<form>
										<span>
											<img src="https://img.icons8.com/color/30/000000/latitude.png"><span id="latitude"> 
										</span>
										</span>
										<span>
											<img src="https://img.icons8.com/color/30/000000/longitude.png"><span id="longitude"> 
											</span>
								</center>
								<br>
								<br>
								<center>
										<form action="#" class="showmap-form" align="right" >
					...
					<div class="forecast-container">
						<div class="today forecast">
							...
							<div class="forecast-content">
								<!-- <div class="location" id = "city-name"></div> -->
								...
								<div class="degree">
									...
									<form>
										<span>
											<img src="images/icon-sun.png" alt=""><span id="morning-div"> 
											</span>
										</span>
										<span>
											<img src="images/icon-a.png" alt=""><span id="afternoon-div"> 
											</span>
										<span>
											<img src="images/icon-n.png" alt=""><span id="night-div"> 
											</span></span>
								</center>
